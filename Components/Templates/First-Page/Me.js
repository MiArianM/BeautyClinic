    ...
    <div className="container text-center flex flex-col justify-between mt-28">
      ...
      <div className="flex items-center">
        <div className="flex flex-col items-center">
          ...
          <Link
            href={
              "https://membersearch.irimc.org/member/profile?id=fd683002-1908-4bfa-9752-e8665051053b"
            }
            target="_blank"
            className="font-regular max-lg:mb-10 text-2xl text-green-600 dark:text-green-400 no-underline transition-all duration-1000 hover:underline underline-offset-8 "
          >
            صفحه نظام پزشکی
          </Link>
      ...
      <div className="flex max-lg:mt-20 items-center flex-row-reverse">
        <div className="flex flex-col items-center">
          <Image
            className="dark:opacity-95"
